...
########################
module "eks_cluster" {
  source  = "km-tf-registry.onrender.com/klyde-moradeyo__dev-generic-tf-modules/eks-cluster/aws"
  version = "0.0.1"
...
module "eks_node_group" {
  source  = "km-tf-registry.onrender.com/klyde-moradeyo__dev-generic-tf-modules/eks-node-group/aws"
  version = "0.0.1"
